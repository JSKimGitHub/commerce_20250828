...
import 'package:commerce_20250828/screen/home/home_widget.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<ProductModel> newProductList = [
    ...
    ProductModel(AssetPath.productShoes, "신발", 100000, 31, 4.3, false),
    ProductModel(AssetPath.productBag, "가방", 890000, 21, 4.7, false),
    ProductModel(AssetPath.productManSuit, "슈트", 90000, 31, 4.3, false),
    ProductModel(AssetPath.productManStreet, "스트리트?", 140000, 11, 4.3, false),
  ];
